...
class BasicAuth(Auth):
    """Implements simple Basic Authorization"""
    ...
    def user_object_from_credentials(self, user_email: str,
        ...
        """Returns a User instance based on email and pw"""
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        """User instance returned based on a received request"""
